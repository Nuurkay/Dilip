...
class ReportZkDevice(models.Model):
    ...
    #change model hr_employee to res_partner
    ...
    def init(self):
        ...
        #changed hr_employee model to res_partner and change employee_id to partner_id
        query = """
            create or replace view azk_report_daily_attendance as (
                select
                    min(z.id) as id,
                    z.partner_id as name,
                ...
                from azk_machine_attendance z
                    join res_partner e on (z.partner_id=e.id)
                GROUP BY
                    z.partner_id,
                    z.write_date,
                    z.address_id,
